...
{
    public record ObjectTrackInfo(BoundingBox InitialBoundingBox, TrackerCSRT Tracker, Rectangle CurrentBox,bool HasDesapeared = false, bool IsInitialized = true, int MaxDisappearance = 3)
    {
